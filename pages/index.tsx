...
const Home: React.FC<HomeProps> = (props) => {
  const pageTitle = getTitle(
    props.blocks,
    "7c218851-994f-4fbe-9e54-6670d3cb76d7"
  );
  ...
  return (
    <>
      <Head>
        ...
        <meta property="twitter:site" content="@jakerullman" />
        <meta property="twitter:creator" content="@jakerullman" />
      ...
      <div className="container mx-auto max-w-4xl">
        <NotionRenderer
          ...
          currentID="7c218851-994f-4fbe-9e54-6670d3cb76d7"
        />
      </div>
    </>
  );
...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  var raw = JSON.stringify({
    pageId: "7c218851-994f-4fbe-9e54-6670d3cb76d7",
    limit: 200,
    cursor: {
      stack: [
        [
          {
            table: "block",
            id: "7c218851-994f-4fbe-9e54-6670d3cb76d7",
            index: 0,
          },
        ],
      ],
